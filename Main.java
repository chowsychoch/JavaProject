...
public class Main {
    ...
    public static void searchForItem(){
        ...
        if (groceryList.onFile(searchItem)){
            ...
            System.out.println(searchItem+" is not in the shopping liat. ");
        }
    }
    ...
    public static void processArrayList(){
        ...
        String[] myArray = new String[groceryList.getGrocertList().size()];
        myArray = groceryList.getGrocertList().toArray(myArray);
    }
